 ...
 * Each option is a self-contained React component using shadcn/ui.
 */
export interface MockOption {
    ...
    description: string;
    /** Full React component code using shadcn/ui imports */
    ...
    schema: {
        ...
        properties: {
            ...
            mockOptions: {
                type: 'array',
                description:
                    'Design mock options as React components. Generate 2-3 distinct design approaches, ' +
                    'each as a self-contained React component using shadcn/ui imports. ' +
                    'Each option should represent a different UI/UX approach to the feature. ' +
                ...
                items: {
                    ...
                    properties: {
                        ...
                        componentCode: {
                            type: 'string',
                            description:
                                'Full React component code. Must be a default-exported function component. ' +
                                'Use only shadcn/ui components from @/client/components/template/ui/. ' +
                                'Use semantic theme tokens (bg-background, text-foreground, etc.). ' +
                                'Design for mobile-first (max-w-md). Include realistic content, not lorem ipsum.',
                        },
                        isRecommended: {
                            type: 'boolean',
                    ...
                    required: ['id', 'title', 'description', 'componentCode', 'isRecommended'],
                },
            },
        },
