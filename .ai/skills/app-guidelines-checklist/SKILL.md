...
**Reference**: See [shadcn-usage](mdc:.cursor/rules/shadcn-usage.mdc) for detailed guidelines and [docs/shadcn-component-library.md](mdc:docs/shadcn-component-library.md) for comprehensive component documentation
